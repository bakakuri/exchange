...
function renderIndex() {
  ...
  html = html.replace('<script src="/app.js?v=8" defer></script>', '<script src="/mobile-menu-compat.js?v=1"></script><script src="/auth-event-fix.js?v=2"></script><script src="/app.js?v=13"></script><script src="/load-data-fix.js?v=1"></script>');
