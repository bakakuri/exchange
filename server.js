...
function renderIndex() {
  ...
  html = html.replace("</body>", tag("/profile-enhancements.js?v=1") + tag("/campaign-enhancements.js?v=1") + tag("/stage2-enhancements.js?v=2") + tag("/ui-polish.js?v=2") + tag("/stage4-product.js?v=3") + tag("/production-hardening.js?v=1") + "</body>");
  return html;
}
...
app.get("/api/platforms", (_req, res) => { res.json(["Instagram", "TikTok", "X", "YouTube", "Facebook"]); });
app.use((req, res) => {
