...
function renderIndex() {
  ...
  html = html.replace("</body>", tag("/profile-enhancements.js?v=1") + tag("/campaign-enhancements.js?v=1") + tag("/stage2-enhancements.js?v=2") + tag("/ui-polish.js?v=2") + tag("/stage4-product.js?v=3") + "</body>");
  return html;
}
