...
function renderIndex() {
  ...
  html = html.replace('<script src="/app.js?v=8" defer></script>', '<script src="/mobile-menu-compat.js?v=1"></script><script src="/app.js?v=12"></script><script src="/auth-event-fix.js?v=1"></script><script src="/load-data-fix.js?v=1"></script>');
  ...
  html = html.replace("</body>", tag("/profile-enhancements.js?v=1") + tag("/campaign-enhancements.js?v=2") + tag("/stage2-enhancements.js?v=3") + tag("/stage4-product.js?v=4") + tag("/production-hardening.js?v=1") + tag("/task-verification.js?v=1") + tag("/promotion-platform-enhancements.js?v=3") + tag("/stability-fix.js?v=1") + tag("/profile-activity-fix.js?v=1") + tag("/task-card-polish.js?v=1") + tag("/interaction-repair.js?v=3") + '<link rel="stylesheet" href="/ui-consistency.css?v=1"><link rel="stylesheet" href="/final-mobile-fix.css?v=2"><link rel="stylesheet" href="/task-profile-fix.css?v=1">' + "</body>");
  return html;
}
